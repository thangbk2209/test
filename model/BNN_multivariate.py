...
class Model:
    ...
    num_units_inference = None, patience = None, number_out_decoder = None, dropout_rate = None):
    ...
    def fit(self):
        ...
        if(self.number_out_decoder == 1):
            ...
            out_weights=tf.Variable(tf.random_normal([int(self.sliding_decoder), 1]))
            ...
            out_weights1=tf.Variable(tf.random_normal([self.sliding_decoder, 1]))
